...
const p1briefCaseChoice2 = () =>{
    ...
    P1boxSelected.innerHTML = P1boxSelected++;
    showCounter()
    removebanner2.parentElement.removeChild(removebanner2)
        showScore()
        P1boxSelected++
        if(P1boxSelected > P2boxSelected){
            player2Turn()
...
Overall.value -= briefP1Amounts.briefcase4.briefcasevalue;
...
const p1briefCaseChoice5 = () =>{
    ...
    P1boxSelected.innerHTML = P1boxSelected++;
    showCounter()
    removebanner5.parentElement.removeChild(removebanner5)
        showScore()
        if(P1boxSelected > P2boxSelected){
            player2Turn()
        }
